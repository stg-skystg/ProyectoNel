   ...
   $(document).ready(function(){     
        ...
        if (contador<20)
        {
             $('<tr id="contra'+contador+'">\n\
                    ...
                    <td><input type="text" class="form-control" type="text" id="cantidad_ord'+contador+'" size="4" name="cantidad_ord'+contador+'" >\n\
                     <td><input type="text" class="form-control" type="text" id="undadms'+contador+'" size="4" name="undadms'+contador+'" >\n\
                     <td><input type="text" class="form-control" type="text" id="obra_cod'+contador+'" size="4" name="obra_cod'+contador+'" >\n\
                    <td><input type="text" class="form-control" type="text" id="valor_unitario'+contador+'" size="4" name="valor_unitario'+contador+'" >\n\
                    <td><input type="text" class="form-control" type="text" id="valor_total'+contador+'" size="4" name="valor_total'+contador+'" >\n\
...
function agregar_campos() 
{
    ...
    $('<tr id="contra'+contador+'">\n\
                                    ...
                                    <input type="text" class="form-control" id="cantidad_ord'+contador+'" size="4"  name="cantidad_ord[]">\n\
                                    <td><input type="text" class="form-control" id="undadms'+contador+'" size="4" readonly name="undadms[]"></Td>\n\
                                    <td><input type="text" class="form-control" id="obra_cod'+contador+'" name="obra_cod[]" onkeyup=Consulta_Producto("'+contador0+'")></td>\n\
                                    <td><input type="text" class="form-control" id="valor_unitario'+contador+'" name="valor_unitario[]" ><input type="text" class="form-control" id="valor_total'+contador0+'" name="valor_total[]" onkeyup=Consulta_Embalaje("'+contador0+'")></td>\n\
