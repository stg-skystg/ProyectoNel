 <div id="page-wrapper">
    ...
    <!-- /.row -->
     <a href="<?php echo getUrl("Vidaplena","vidaplena","listarIn"); ?>"><button class="btn btn-success">DESPACHADOS</button></a>
     <br>
     <br>
     <br>
    <div class="row">
                                ...
                                <?php
                                    foreach ($producto as $productos){                                
                                        echo '<tr class="gradeA odd" role="row" style="text-align: center;">
                                                ...
                                                <td> 
                                                <a href="index.php?modulo=Vidaplena&controlador=vidaplena&funcion=getEditar&idpedido='.$productos['idpedido'].'"><button class="btn btn-info btn-circle btn-md"><i class="fa fa fa-check"></i></button></a>


                                                <a href="index.php?modulo=Vidaplena&controlador=vidaplena&funcion=despachar&idpedido='.$productos['idpedido'].'"><button class="btn btn-info btn-circle btn-md"><i class="fa fa fa-check"></i></button></a>
