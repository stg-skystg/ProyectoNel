a<div id="page-wrapper">
    ...
    <a href="<?php echo getUrl("inventario","inventario","listarIn"); ?>"><button class="btn btn-danger">INACTIVOS</button></a>
    <br>
    <br>
    <!-- /.row -->
    <div class="row">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th  rowspan="1" colspan="1" >VALOR ACTUAL</th>
                                ...
                                <?php
                                    foreach ($inventario as $inventarios){                                
                                        echo '<tr class="gradeA odd" role="row" style="text-align: center;">
                                                ...
                                                <td>'.$inventarios['fecha_inv'].'</td>
                                                <td>'.$inventarios['linea_inv'].'</td>
                                                <td>'.$inventarios['grupo_inv'].'</td>
                                                <td>'.$inventarios['elemento_inv'].'</td>
                                                <td>'.$inventarios['descripcion_inv'].'</td>
                                                <td>'.$inventarios['valorone'].'</td>
                                                <td>'.$inventarios['valortwo'].'</td><td>';
                                               ...
                                               echo '</td><td>
                                                    <a href="index.php?modulo=inventario&controlador=inventario&funcion=getEditar&id_inve='.$inventarios['id_inv'].'"><button class="btn btn-primary btn-circle btn-md"><i class="fa fa fa-list"></i></button></a>
                                                    <a href="index.php?modulo=inventario&controlador=inventario&funcion=getEliminar&id_inve='.$inventarios['id_inv'].'"><button class="btn btn-danger btn-circle btn-md"><i class="fa fa fa-times"></i></button></a>
