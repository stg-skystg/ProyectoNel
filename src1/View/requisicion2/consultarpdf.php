...
Fabrica y Oficinas: Carrera 34 No10-445 Acopi - Cali Colombia Conmutador: (57) (2) - 6959110 Email: coin@coinsas.co</h5>
                    <img src="../../img/logoc.jpg" height="80" width="80"></center>
                            ...
                            <div class="row">
                             ...
                             <table>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  name="telefono2"  size="40" maxlength="40" value="<?php echo $productos[18]?>">

                                        </div><div class="form-group">
                                            <label>TELEFONO:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input  name="telefono1"  size="40" maxlength="40" value="<?php echo $productos[19]?>">

                                        </div>
                                        <div class="form-group">
                                            <label>FORMA DE PAGO:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input  name="forma_pago"  size="40" maxlength="40" value="<?php echo $productos[20]?>">
